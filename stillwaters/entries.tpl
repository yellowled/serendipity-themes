<!-- ENTRIES START -->
    ...
    <div class="serendipity_Entry_Date">
        ...
        <div class="serendipity_subtitle">
        ...
        <div class="serendipity_entry serendipity_entry_author_{$entry.author|@makeFilename} {if $entry.is_entry_owner}serendipity_entry_author_self{/if}">
            ...
            <div class='serendipity_entryFooter'>
                ...
                {if $entry.has_trackbacks}
                    {if $use_popups}
                        | <a href="{$entry.link_popup_trackbacks}" onclick="window.open(this.href, 'comments', 'width=480,height=480,scrollbars=yes'); return false;">{$entry.trackbacks} {$entry.label_trackbacks}</a>
                    {else}
                        | <a href="{$entry.link}#trackbacks">{$entry.trackbacks} {$entry.label_trackbacks}</a>
                    {/if}
                {/if}
