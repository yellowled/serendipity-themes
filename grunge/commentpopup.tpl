...
<head>
   ...
   <!-- <link rel="stylesheet" type="text/css" href="{serendipity_getFile file="grey.css"}" /> -->
   <!-- {elseif $template_option.colorset == 'caramel'} -->
   <!-- <link rel="stylesheet" type="text/css" href="{serendipity_getFile file="caramel.css"}" /> -->
   <!-- {elseif $template_option.colorset == 'modern'} -->
   <!-- <link rel="stylesheet" type="text/css" href="{serendipity_getFile file="modern.css"}" /> -->
   <!-- {/if} -->
</head>
